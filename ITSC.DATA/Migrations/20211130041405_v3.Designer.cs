            ...
            modelBuilder.Entity("ITSC.CORE.Clase", b =>
                {
                    ...
                    b.Property<int?>("materiacarreraid1")
                        .HasColumnType("int");

                    b.Property<int?>("materiacarreraidid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("materiacarreraid1");

                    b.HasIndex("materiacarreraidid");
            ...
            modelBuilder.Entity("ITSC.CORE.Clase", b =>
                {
                    b.HasOne("ITSC.CORE.MateriaCarrera", "materiacarrera")
                        .WithMany()
                        .HasForeignKey("materiacarreraid1");

                    b.HasOne("ITSC.CORE.MateriaCarrera", "materiacarreraid")
                        .WithMany()
                        .HasForeignKey("materiacarreraidid");

                    b.Navigation("materiacarrera");

                    b.Navigation("materiacarreraid");
                });
